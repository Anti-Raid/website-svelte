...
>
	<h5 class="mb-2 text-2xl font-bold tracking-light text-gray-900 dark:text-white"><img class="h-8 rounded-full" src={image} height="32px" width="32px" alt="Card Image" /> {title}</h5>
