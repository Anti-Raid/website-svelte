<footer class="px-4 divide-y dark:dark:bg-gray-800 dark:dark:text-gray-100">
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				<div class="flex items-center justify-center w-12 h-12 rounded-full dark:dark:bg-violet-400">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="flex-shrink-0 w-5 h-5 rounded-full dark:dark:text-gray-900">
	...
	<div class="py-6 text-sm text-center dark:dark:text-gray-400">© 1968 Company Co. All rights reserved.</div>
</footer>
