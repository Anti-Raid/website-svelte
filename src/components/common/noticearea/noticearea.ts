...
export const noticeAreaLevelsArray: NoticeAreaLevels[] = ['loading', 'info', 'warn', 'error', 'success']
...
export const getDisplay = (level: NoticeAreaLevels, className?: string, disabled?: boolean): Display => {
    logger.info('getDisplay', 'Getting display for level', level, 'with class name', className, 'and disabled', disabled);
    switch (level) {
        case 'loading':
            return {
                icon: 'mdi:loading',
