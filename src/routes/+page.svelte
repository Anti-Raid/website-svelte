			...
			<dl class="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
				<div class="relative">
					<dt>
						...
						<p class="ml-16 text-lg font-medium leading-6 text-white">Anti Raid</p>
					</dt>
				...
				<div class="relative">
					...
					<dd class="mt-2 ml-16 text-base text-white">
						Everytime a action occurs on your server, we will send a message to a specific channel
						to help better protect your server against attackers.
					</dd>
				</div>
			</dl>
		</div>
